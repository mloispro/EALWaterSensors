...
void setup() {
  ...
  bool esp8266started = wifi.begin();
  Serial.print("esp8266started: ");
  Serial.println(esp8266started);
//
//  bool wifi_started = wifi.begin();
//  if (wifi_started) {
//    wifi.connectToAP("One Love", "teddy1207");
...
//  }
  ...
  bool serverStart = wifi.startLocalAPAndServer("One Love", "teddy1207", "5", "80");
  Serial.print("serverStart: ");
  Serial.println(serverStart);
//  
//  bool conToWifi = wifi.connectToAP("One Love", "teddy1207");
//  Serial.print("conToWifi: ");
//  Serial.println(conToWifi);
//  
//  bool conToServer = wifi.connectToServer("192.168.10.102", "80");
//  Serial.print("conToServer: ");
//  Serial.println(conToServer);
...
void loop() {
  ...
  if (!wifi.isStarted()){
    wifi.send(SERVER, "**!wifi.isStarted()");
    //Serial.println(serverStart);
    wifi.begin();
  }
